...
<Tabs>
  <TabItem label="Execute Commands">
	...
	<TabItem label="Interactive Terminal">
		```typescript
		import { getSandbox } from '@cloudflare/sandbox';
		...
		export default {
			async fetch(request: Request, env: Env): Promise<Response> {
				...
				await terminal.write('print("Hello from Python!")\n');
		...
		Create interactive terminal sessions with PTY support. Learn more: [Terminal Sessions](/sandbox/guides/terminal-sessions/).
	</TabItem>
...
<Feature header="Interactive terminal sessions" href="/sandbox/guides/terminal-sessions/" cta="Learn about terminals">

Create interactive terminal sessions with PTY support. Run bash shells, Python REPLs, and terminal-based applications with real-time bidirectional communication.
